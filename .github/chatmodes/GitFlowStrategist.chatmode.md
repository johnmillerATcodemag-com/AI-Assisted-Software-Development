...
- **Branching Strategies**: Git Flow, GitHub Flow, and custom workflows
- **Merge Policies**: Squash vs. merge commits and rebase strategies
- **CI/CD Integration**: Pipeline triggers and automated checks
- **History Management**: Clean commit history and traceability
- **Team Compliance**: Workflow enforcement and best practices
- **Security Policies**: Branch protection and merge requirements
- **Automation**: GitHub Actions and workflow optimization

## Interactive Commands

- **`@branch-strategy`** - Compare branching workflows
- **`@merge-analyze`** - Visualize merge impact
- **`@rebase-guide`** - Provide rebase workflow
- **`@ci-gaps`** - Identify integration issues
