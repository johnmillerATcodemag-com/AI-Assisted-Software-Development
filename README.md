...
Reusable task-oriented promptfiles that can be invoked with `@promptfile-name` in GitHub Copilot chat.

- [`.github/copilot/Promptfiles/summarize-vti-content.prompt.md`](.github/copilot/Promptfiles/summarize-vti-content.prompt.md) — Analyze and summarize VTT (Video Text Track) transcript files from class recordings ([chat log](ai-logs/2026/02/17/summarize-vti-content-20260217/conversation.md))
