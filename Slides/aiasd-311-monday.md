...
source: "Slides/aiasd-311-monday.yaml"
manifest: "Slides/aiasd-311-monday.yaml"
marp: true
theme: default
paginate: true
...
## Monday Session — Complete Course

*AI Output Standards · CQRS · Dependency Management · GitHub CLI · Vertical Slices · Custom Agents*

::: notes
Welcome to the AI-Assisted Software Development with GitHub Copilot Monday session (AIASD-311). This combined presentation covers all six modules of the course.

**Timing**: 1 minute

**Session Overview**:
This deck merges six individual module presentations into a single comprehensive course deck, assembled from the manifest at Slides/aiasd-311-monday.yaml. Each module is separated by a section divider slide so you can navigate or present individual sections.

**Modules in This Deck**:
1. **AI-Assisted Output** — Provenance, logging, and quality standards for AI-generated artifacts
2. **CQRS Architecture** — Command Query Responsibility Segregation — when and how to apply it
...
**Delivery Options**:
- Present all modules end-to-end as a full-day training (estimated 6–8 hours)
...
**Audience**: Developers, DevOps engineers, and architects with basic familiarity with Git and VS Code.
...
*Provenance, logging, and quality standards for AI-generated artifacts*
...
**Module Description**: Provenance, logging, and quality standards for AI-generated artifacts.
...
*Command Query Responsibility Segregation — when and how to apply it*
...
**Module Description**: Command Query Responsibility Segregation — when and how to apply it.
...
*Risk classification, selection criteria, vulnerability monitoring, and supply chain security*
...
*Issue and PR management, Actions monitoring, code review, and CI/CD integration*
...
*Extracting rules, identifying use cases, defining feature boundaries, and designing slices*
...
*Creating, configuring, and deploying custom GitHub Copilot agents across environments*
