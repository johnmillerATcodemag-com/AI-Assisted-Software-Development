...
chat_id: "merge-marp-decks-311-tuesday-20260320"
prompt: |
  $MANIFEST = Slides/aiasd-311-tuesday.yaml
  Follow instructions in merge-marp-decks.prompt.md.
started: "2026-03-20T03:11:08Z"
ended: "2026-03-20T03:45:00Z"
task_durations:
...
ai_log: "ai-logs/2026/03/20/merge-marp-decks-311-tuesday-20260320/conversation.md"
source: "Slides/aiasd-311-tuesday.yaml"
marp: true
theme: default
paginate: true
---
...
::: notes
Welcome to AIASD Class 311, Tuesday session. This combined presentation covers six modules: AI output standards, CQRS architecture, dependency management policy, GitHub CLI workflows, business rules to vertical slices, and creating custom GitHub Copilot agents.
...
**Module Description**: This module covers mandatory metadata requirements for all AI-generated artifacts, the AI chat logging workflow, quality gates, CI enforcement patterns, and post-creation requirements. Students will learn the 10-field provenance block and how to configure CI to block non-compliant artifacts.
...
**Module Description**: This module covers when to use CQRS, its core principles, architecture components, command and query model design, consistency strategies including the outbox pattern, migration approaches, and common anti-patterns to avoid.
...
**Module Description**: This module covers risk-based dependency classification, selection criteria and approval workflows, version management strategies, security vulnerability monitoring with SLAs, license compliance, supply chain security, and emergency patching procedures.
...
**Module Description**: This module covers issue and PR management, GitHub Actions monitoring and control, code review workflows, IDE and CI/CD integration, and a reference of the most commonly used `gh` commands for daily developer workflows.
...
**Module Description**: This module covers the 6-step analysis workflow for converting business requirements into vertical slices: extracting the four types of business rules, identifying use cases, applying feature boundary tests, designing complete slice specifications, and producing an implementation roadmap.
...
**Module Description**: This module covers the structure and naming of GitHub Copilot custom agent files, YAML frontmatter configuration, prompt content guidelines, tool access control, MCP server integration, creating agents via GitHub.com and IDEs, and templates for common agent archetypes.
