...
prompt: |
  Extract module 6 (Creating Custom Agents) from Slides/ai-assisted-dev-overview.md
  into individual slide file Slides/individual-slides/creating-custom-agents.md
