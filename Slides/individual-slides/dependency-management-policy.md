...
prompt: |
  Extract module 3 (Dependency Management Policy) from Slides/ai-assisted-dev-overview.md
  into individual slide file Slides/individual-slides/dependency-management-policy.md
